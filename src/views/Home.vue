    ...
    <div class="row" style="margin-left: 0!important; margin-right:0!important;">
                        ...
                        <div class="card" style="background: black;">
                            ...
                            <h5 class="card-title titHome">{{movie.name}}</h5>
                         ...
                         <router-link 
                            ...
                            <div class="centra">
                            <button type="button" class=" botton"    v-if="language==='it-IT' ">mostra altro</button>
                            <button type="button" class=" botton"    v-if="language==='en-US' ">show more</button>
                             </div>
                            </router-link>
                        </div>

...
<link href="https://fonts.googleapis.com/css2?family=Fascinate&family=Monoton&display=swap" rel="stylesheet">
    ...
    data(){
        ...
        methods:{
                ...
                async getpost() 
                {  
                    const res = await fetch('https://api.themoviedb.org/3/trending/tv/day?api_key='+this.api_key+'&language='+this.language)
            ...
            async newGP(){
                ...
                const ris=await fetch('https://api.themoviedb.org/3/trending/tv/day?api_key='+this.api_key+'&page='+this.page)
